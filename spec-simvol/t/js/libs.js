var mnemonik = {
	...
	170: "ordf",	171: "laquo",	187: "raquo",	172: "not",		173: "shy",
	174: "reg",		175: "macr",	176: "deg",		177: "plusmn",	178: "sup2",
	179: "sup3",	180: "acute",	181: "micro",	182: "para",	183: "middot",
	184: "cedil",	185: "sup1",	186: "ordm",	188: "frac14",	189: "frac12",
	...
	39: "apos",		34: "quot",		38: "amp",		60: "lt",		62: "gt",
...
function Calc(){
	//&#8381;
	var temphex;
	$("#past").on("keyup", function(){
		//GoCalc(this.value);
		
		val = $(this).val();
		
		temphex = val.hexEncode();
		
		num = parseInt(temphex, 16)
		
		//$("#r_cod").html("&#" + num.toString(10) + ";");
		$("#r_cod").html("&amp;#" + num.toString(10) + ";");
		
		if(mnemonik[num.toString(10)]){
			$("#r_mne").html("&amp;" + mnemonik[num.toString(10)] + ";");
		} else {
			$("#r_mne").html("");
		}
		
		
		$("#r_content").html(': "\\' + temphex + '";');
		
		$("#result").html('<font size="1">' + $(this).val() + '</font> <font size="3">' + $(this).val() + '</font> <font size="6">' + $(this).val() + '</font>');
